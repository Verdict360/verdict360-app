...
-- Create indexes for better performance with seed data
...
CREATE INDEX IF NOT EXISTS idx_case_law_references_year ON case_law_references(year);
CREATE INDEX IF NOT EXISTS idx_case_law_references_jurisdiction ON case_law_references(jurisdiction);
